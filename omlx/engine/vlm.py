...
class VLMBatchedEngine(BaseEngine):
    ...
    async def start(self) -> None:
        ...
        def _load_vlm_sync():
            ...
            # omni: generic torch-free AutoProcessor fallback (fork-only).
            # upstream 0.5.3: dedicated Pixtral/Mistral3 torch-free path (#2263).
            # Both are idempotent and compose regardless of ordering — keep both.
            ...
            with (
                ...
                # per-model context managers, so keep both.
